...
4. [Control Flow](04-control-flow/) - if/else, switch, for, while, break/continue
5. [Functions](05-functions/) - Membuat fungsi, parameter, return values
6. [Arrays & Matrices](06-arrays-and-matrices/) - Vektor, matriks, operasi matriks
...
11. [Cell Arrays & Structures](11-cell-arrays-and-structures/) - Cell, struct, tables
...
20. [Parallel Computing](20-parallel-computing/) - parfor, GPU computing, distributed
21. [GUI Development](21-gui-development/) - App Designer, uifigure, callbacks
22. [Simulink Basics](22-simulink-basics/) - Model-based design, blok diagram
23. [Real-World Projects](23-real-world-projects/) - Proyek lengkap end-to-end

## Cara Menggunakan Tutorial Ini

1. Buka MATLAB (R2019b atau lebih baru direkomendasikan)
2. Ikuti tutorial secara berurutan dari Bab 1
3. Jalankan setiap file `.m` untuk melihat hasilnya
4. Modifikasi kode dan eksperimen sendiri
5. Kerjakan latihan di akhir setiap bab

## Prasyarat

- MATLAB terinstal (R2019b+)
- Untuk bab tertentu: Signal Processing Toolbox, Image Processing Toolbox,
  Parallel Computing Toolbox, Simulink

## Konvensi Penulisan

- `% PENJELASAN` — komentar penjelasan dalam kode
- `%% Section` — pembatas section dalam script
- `>>> Output` — contoh output yang diharapkan
- Setiap bab memiliki file `latihan.m` untuk praktik mandiri
